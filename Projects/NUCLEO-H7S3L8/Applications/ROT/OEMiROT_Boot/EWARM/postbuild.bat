...
if exist "%appli_dir%\EWARM\stm32h7rsxx_RAMxspi2_ROMxspi1.icf" (
    ...
    set appli_linker_file="%appli_dir%\EWARM\stm32h7rsxx_RAMxspi2_ROMxspi1.icf"
) else (
    if exist "%appli_dir%\..\EWARM\Appli\stm32h7rsxx_RAMxspi2_ROMxspi1.icf" (
        REM Project configuration "Templates"
        set appli_linker_file="%appli_dir%\..\EWARM\Appli\stm32h7rsxx_RAMxspi2_ROMxspi1.icf"
    ) else (
        echo No valid icf file found
        goto :error
    )
)
