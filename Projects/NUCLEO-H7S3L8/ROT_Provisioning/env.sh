...
if [ "$OS" == "Windows_NT" ]; then
    ...
    stm32ExtLoaderFlash="-elbl $stm32programmercli_path/ExternalLoader/MX25UW25645G_NUCLEO-H7S3L8-XSPIM1-OBL.stldr"
    stm32ExtLoaderFlashOpen="-el $stm32programmercli_path/ExternalLoader/MX25UW25645G_NUCLEO-H7S3L8-XSPIM1.stldr"
else
